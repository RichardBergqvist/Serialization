...
public class TCField extends TCBase {
	...
	public static TCField Byte(String name, byte value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Short(String name, short value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Char(String name, char value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Int(String name, int value) {
		TCField field = new TCField();
		field.setName(name);
		field.type = Type.INT;
	...
	public static TCField Long(String name, long value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Float(String name, float value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Double(String name, double value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField Boolean(String name, boolean value) {
		TCField field = new TCField();
		field.setName(name);
	...
	public static TCField deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == ContainerType.FIELD);
		
		TCField result = new TCField();
