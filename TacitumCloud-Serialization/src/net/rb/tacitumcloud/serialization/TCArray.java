...
public class TCArray extends TCBase {
	...
	public static TCArray Byte(String name, byte[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Short(String name, short[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Char(String name, char[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Int(String name, int[] data) {
		TCArray array = new TCArray();
		array.setName(name);
		array.type = Type.INT;
		array.count = data.length;
	...
	public static TCArray Long(String name, long[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Float(String name, float[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Double(String name, double[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray Boolean(String name, boolean[] data) {
		TCArray array = new TCArray();
		array.setName(name);
	...
	public static TCArray deserialize(byte[] data, int pointer) {
		byte containerType = data[pointer++];
		assert(containerType == ContainerType.FIELD);
		
		TCArray result = new TCArray();
